...
public abstract class BoarAIMoveToBlock extends MoveToBlockGoal {
    ...
    public BoarAIMoveToBlock(PathfinderMob mob, double p_25610_, int p_25611_) {
        this(mob, p_25610_, p_25611_, 1);
    }

    public BoarAIMoveToBlock(PathfinderMob mob, double p_25614_, int p_25615_, int p_25616_) {
        super(mob, p_25614_, p_25615_, p_25616_);
        this.mob = mob;
